      ...
      <div className="flex w-full h-full relative z-10">
        ...
        <div className="w-full md:max-w-3xl lg:max-w-4xl h-full flex flex-col shadow-2xl relative">
          ...
          <div className="flex-1 flex flex-col w-full h-full glass-card border-x border-white/10 dark:bg-black dark:border-white/10 transition-colors duration-300">
            ...
            <main className="flex-1 overflow-y-auto p-4 md:p-6 scrollbar-thin scrollbar-thumb-primary/20 scrollbar-track-transparent">
              <div className={cn(
                "min-h-full flex flex-col pb-[140px] md:pb-6",
                messages.length > 0 ? "justify-end" : "justify-center"
              )}>
                {messages.length === 0 ? (
                  <div className="flex flex-col items-center justify-center text-center text-muted-foreground space-y-4 p-8">
